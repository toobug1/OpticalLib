...
//void TRenderer::set_ray_intensity_mode(IntensityMode m)
//{
//    _intensity_mode = m;
//}
...
//void TRenderer::draw_trace_result_3d(const TResult &result, bool hit_image, const TElement *ref)
//{
//    group_begin("rays");
...
//void TRenderer::draw_intercepts(const TResult &result, const Sys::Surface &s)
//{
//    _max_intensity = result.get_max_ray_intensity();
...
//const TRgb TRenderer::ray_to_rgb(const Light::Ray & ray)
//{
...
//float TRenderer::ray_to_alpha(const Light::Ray & ray) const
//{
...
//void TRenderer::draw_polygon(const Math::Vector2 *array, unsigned int count, const TRgb &TRgb, bool filled, bool closed)
//{
//    unsigned int i;
...
//    for (i = 0; i + 1 < count; i++)
//        draw_segment(Math::VectorPair2(array[i], array[i + 1]), TRgb);

//    if (closed)
//        draw_segment(Math::VectorPair2(array[i], array[0]), TRgb);
//}

//void TRenderer::draw_circle(const Math::Vector2 &v, double r, const TRgb &TRgb, bool filled)
//{
...
//void TRenderer::draw_triangle(const Math::Triangle<3> &t, const TRgb &TRgb)
//{
//    draw_polygon(&t[0], 3, TRgb, false, true);
//}

//void TRenderer::draw_triangle(const Math::Triangle<3> &t, const Math::Triangle<3> &gradient, const TRgb &TRgb)
//{
//    draw_triangle(t, TRgb);
//}

//void TRenderer::draw_polygon(const Math::Vector3 *array, unsigned int count,
//                            const TRgb &TRgb, bool filled, bool closed)
//{
//    if (count < 3)
//        return;
...
//    for (i = 0; i + 1 < count; i++)
//        draw_segment(array[i], array[i + 1], TRgb);

//    if (closed)
//        draw_segment(array[i], array[0], TRgb);
//}

//void TRenderer::draw_box(const Math::VectorPair2 &c, const TRgb &TRgb)
//{
//    draw_segment(Math::Vector2(c[0].x(), c[0].y()), Math::Vector2(c[1].x(), c[0].y()), TRgb);
//    draw_segment(Math::Vector2(c[1].x(), c[1].y()), Math::Vector2(c[1].x(), c[0].y()), TRgb);
//    draw_segment(Math::Vector2(c[1].x(), c[1].y()), Math::Vector2(c[0].x(), c[1].y()), TRgb);
//    draw_segment(Math::Vector2(c[0].x(), c[0].y()), Math::Vector2(c[0].x(), c[1].y()), TRgb);
//}

//void TRenderer::draw_triangle(const Math::Triangle<2> &t, bool filled, const TRgb &TRgb)
//{
//    draw_polygon(&t[0], 3, TRgb, filled, true);
//}
